...
const getMaximizeToggleAction = (window) => window.position.state === 'MAXIMIZED' ? types_1.WindowAction.Restore : types_1.WindowAction.Maximize;
const getMaximizeToggleClassName = (window) => window.position.state === 'MAXIMIZED' ? 'fa fa-window-restore' : 'fa fa-window-maximize';
