...
class WindowManager extends React.Component {
    ...
    render() {
        const openWindows = this.state.openWindows
            ...
            .map((openWindow, i) => (React.createElement(activity_window_1.default, { key: openWindow.key, depth: i, window: openWindow, availableActivities: this.state.availableActivities, onFocus: this.onWindowFocus, onDragStart: this.onWindowDragStart, onWindowAction: (action, options) => { this.onWindowAction(action, openWindow, options); } })));
